      ...
      <div className="w-full min-h-[calc(100vh-100px)] flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 max-w-7xl mx-auto p-4 md:p-8 relative z-10">
        ...
        <div className="hidden lg:block w-full max-w-md relative">
          <div className="transform scale-90 hover:scale-100 transition-transform duration-500 relative flex flex-col items-center">
            ...
            >
                <div className="bg-white p-3 pb-12 border-[3px] border-[#2D3436] shadow-[4px_4px_0px_rgba(0,0,0,0.1)] rounded-sm w-[240px] relative">
                    <Image
                        ...
                        priority
                    />
                    <div className="absolute bottom-4 left-0 w-full text-center font-handwriting text-gray-400 text-sm">
                        AI Result
                    </div>
                </div>
            </motion.div>
